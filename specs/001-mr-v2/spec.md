...
运营商可以注册账户、在线充值（微信支付、支付宝、银行转账）、查看实时余额、查看交易记录（充值/消费），并在需要时申请退款（仅退当前余额）和开具发票。

**Why this priority**: 运营商必须能够管理资金才能使用系统。充值是扣费的前提，财务透明度是信任的基础。

**Independent Test**: 创建运营商账户，通过微信/支付宝充值100元，通过银行转账申请充值500元并上传凭证，启动游戏消费50元，查看余额为50元，申请退款并通过审核后余额归零。
...
3. **Given** 运营商需要大额充值，**When** 选择银行转账并上传转账凭证500元，**Then** 创建充值申请状态为待审核，财务人员审核通过后余额增加500元
4. **Given** 运营商已消费50元（余额剩50元），**When** 申请退款，**Then** 财务人员审核通过后系统退还50元，余额清零，账户仍可正常使用
5. **Given** 运营商账户有充值记录，**When** 申请开具发票，**Then** 系统生成电子发票并提供下载链接
6. **Given** 充值过程中支付平台返回失败，**When** 系统接收回调，**Then** 账户余额不变，充值记录标记为"失败"
...
财务人员可以查看整体收入概览（今日充值/消费/退款/净收入）、分析大客户消费情况（TOP客户收入占比）、审核退款申请（查看运营商总充值/总消费/当前余额）、审核银行转账充值申请（查看转账凭证、批准/拒绝申请、充值到账）、生成日/周/月财务报表并导出，所有操作记录审计日志。

**Why this priority**: 财务透明和审计合规是企业运营的必要条件，但不影响核心业务流程，可后置实现。

**Independent Test**: 财务人员登录后台，查看今日收入仪表盘显示充值1000元、消费500元、净收入500元，查看TOP5客户列表，审核一笔退款申请并通过，审核银行转账充值申请（查看凭证并批准充值到账），导出本月财务报表PDF，查看审计日志显示所有操作记录。
...
6. **Given** 运营商通过银行转账申请充值500元并上传凭证，**When** 财务人员审核时查看详情，**Then** 显示运营商信息、转账金额500元、转账凭证图片，审核通过后账户余额增加500元
7. **Given** 运营商银行转账凭证不清晰，**When** 财务人员拒绝申请并填写原因，**Then** 申请状态更新为"已拒绝"，运营商可在账户中查看拒绝原因
...
- **FR-007a**: 系统必须支持银行转账充值方式，运营商可提交转账申请并上传凭证，财务人员审核通过后充值到账
...
- **FR-042**: 系统必须支持财务人员独立登录（不同于运营商账号），权限包括查看财务数据、审核退款/发票、审核银行转账充值申请
